...
When(/^I search for "([^"]*)"$/) do |valueToSearch|
  @page.searchPage.searchAndFillForName('q',valueToSearch)
end
...
Then(/^I see that the UCB is located at "([^"]*)" street$/) do |adUCB|
  address = @page.findPage.findByXpath('/html/body/div[7]/div/div[10]/div[2]/div/div/div[2]/div/div[3]/div/div/div/div/div[1]/div/div/div/div/div[4]/div/div/div/span[2]')
