...
Then('I see text about working hours {string}') do |workingHoursUCB|
  workingHoursLabel = find(:xpath, '/html/body/div[1]/div[2]/div[2]/div[1]/div/div[3]/div/ul/li[1]/div/p')
